import os
DEBUG_MODE = bool(os.getenv("AS2_DEBUG_MODE"))
...
MOB_ID_OFFSET = 0x100000000

MOB_TYPE_PLAYER = "player"
MOB_TYPE_NPC = "npc"  # This includes monsters.
...
PLAYER_STARTING_POSITION = (334, 209, DIR_WEST)
...
ITEMPOS_VOID      = "ITEMPOS_VOID"
ITEMPOS_MAP       = "ITEMPOS_MAP"
ITEMPOS_INVENTORY = "ITEMPOS_INVENTORY"
ITEMPOS_EQUIPMENT = "ITEMPOS_EQUIPMENT"
ITEMPOS_HOLDING   = "ITEMPOS_HOLDING"
