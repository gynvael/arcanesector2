...

{
  ...
  { "3d_rock_door", "gfx/cave_entrance_wall.png" },
  ...
  { "3d_inner_wall", "gfx/Wall_1.png" },
  { "3d_wall", "gfx/Wall_0.png" },
  { "3d_ceil", "gfx/ceil.png" },
  { "3d_wall_door", "gfx/Wall_0_Door.png" },
  { "3d_wall_win0", "gfx/Window_0_wall.png" },
  { "3d_wall_win1", "gfx/Window_1_wall.png" },
  ...
  { "3d_mob_drow_m_green", "gfx/Male_Character_3_green.png" },
  { "3d_mob_drow_f_ms", "gfx/Female_Character_3_master_sergeant.png" },
  { "3d_mob_drow_m_party", "gfx/Male_Character_3_party.png" },
  { "3d_mob_drow_f_party", "gfx/Female_Character_3_party.png" },
  { "switch_on", "gfx/switch_on.png" },
  { "switch", "gfx/switch_off.png" },
  { "blocker", "gfx/wall.png" },
  { "blocker_open", "gfx/gold_frame.png" },
  { "book_stand", "gfx/Book_Stand.png" },
  ...
  { "items_2", "gfx/henry_software_items.png" },
  { "items_3", "gfx/kyrises_items.png" },
  { "items_mining", "gfx/mining.png" },
  { "sign", "gfx/sign.png" },
  { "lamppost", "gfx/Lamppost.png" },
